...
class TicketView extends StackedView<TicketViewModel> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildHallSection(viewModel),
                ],
              ),
            ),
            const Spacer(),
            _buildSelectSeatsButton(viewModel)
          ],
        ),
      ),
    );
  ...
  Center _buildSelectSeatsButton(TicketViewModel viewmodel) {
    return Center(
  ...
  Column _buildHallSection(TicketViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(
  ...
  Widget _buildDateSelector(TicketViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => InkWell(
              ...
              onTap: () => viewModel.setSelectedDateIndex(index),
              child: Chip(
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        // if (rowIndex == 13) ...[
        //   // Middle seats (Last row has 6 seats evenly spaced)
        //   if (rowIndex == 13) ...[
        //     Row(
        //       mainAxisAlignment: MainAxisAlignment.spaceBetween,
        //       children: List.generate(6, (index) => const SeatWidget()),
        //     ),
        //   ] else ...[
        //     Wrap(
        //       spacing: 2.58.w,
        //       children:
        //           List.generate(middleSeats, (index) => const SeatWidget()),
        //     ),
        //   ],
        // ] else ...[
        Wrap(
